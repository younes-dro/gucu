 ...
 * 
 * @class Gucu_Custom_Queries_Dependencies
...
class Gucu_Custom_Queries_Dependencies {
    ...
    public static function get_php_notice() {
        ...
        return sprintf(
                esc_html__( 'The minimum PHP version required for this plugin is %1$s. You are running %2$s.', 'gucu')
    ...
    public static function get_wp_notice(){
        ...
        return sprintf(
                esc_html__( '%s is not active, as it requires WordPress version %s or higher. Please %supdate WordPress &raquo;%s', 'gucu')
